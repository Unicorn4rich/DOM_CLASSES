...
myButton1?.addEventListener('click', ()=>{      // button1 pe click karne se Sir ne in dono ko apas mein larwa diyya
...
myButton2?.addEventListener('click', ()=>{      // button2 click
...
myButton1?.addEventListener('click', ()=>{        // Button1 pe jese hi click hoga 
